...
int main(void)
{
    ...
    printf("Preloading frame buffer\n");
...
/* Uncommented the mutate_background_color function */
static void mutate_background_color(void)
{
...
/* Adjusted the lcd_tft_isr function to call mutate_background_color */
...
/* Modify the draw_layer_1 function to display your strings */
static void draw_layer_1(void)
{
    ...
    int x = LCD_LAYER1_WIDTH - 10; // Right edge minus 10-pixel margin
    int y = 20; // Starting y position

    draw_string(x, y, my_string, text_color);
}
