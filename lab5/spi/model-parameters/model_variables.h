...
#include "tflite-model/tflite_learn_12.h"
#include "edge-impulse-sdk/classifier/ei_model_types.h"
#include "edge-impulse-sdk/classifier/inferencing_engines/engines.h"

const char* ei_classifier_inferencing_categories[] = { "arriba_abajo", "circulo", "golpe" };

uint8_t ei_dsp_config_11_axes[] = { 0, 1, 2 };
const uint32_t ei_dsp_config_11_axes_size = 3;
ei_dsp_config_spectral_analysis_t ei_dsp_config_11 = {
    11, // uint32_t blockId
...
const ei_config_tflite_graph_t ei_config_tflite_graph_12 = {
    .implementation_version = 1,
    .model = tflite_learn_12,
    .model_size = tflite_learn_12_len,
    .arena_size = tflite_learn_12_arena_size
};
...
const uint32_t ei_learning_block_12_inputs[1] = { 11 };
const uint8_t ei_learning_block_12_inputs_size = 1;
...
const ei_impulse_t impulse_526310_0 = {
    .project_id = 526310,
    .project_owner = "María Pérez",
    .project_name = "ProyectoMicros",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_526310_0 = ei_impulse_handle_t( &impulse_526310_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_526310_0;
